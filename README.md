...
![Bot Status Example](https://i.imgur.com/R7YTUad.png)
...
1.  **Clone the repository (or download ZIP):**
    ```bash
    git clone https://github.com/etherinus/rust-server-monitoring.git # Replace with your repository link if different
    cd rust-server-monitoring # Go to the project folder (adjust if your folder name is different)
    ```
